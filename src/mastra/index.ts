...
// Import workflow, agent, and tools
import { newsAutomationWorkflow } from "./workflows/newsAutomationWorkflow";
...
export const mastra = new Mastra({
  ...
  workflows: { newsAutomationWorkflow },
  mcpServers: {
...
// Register the cron trigger for daily news automation at 8:00am PDT
// Using environment variables for customization with defaults
registerCronWorkflow(
  `TZ=${process.env.SCHEDULE_CRON_TIMEZONE || 'America/Los_Angeles'} ${process.env.SCHEDULE_CRON_EXPRESSION || '0 8 * * *'}`,
  newsAutomationWorkflow
);
